#!/bin/bash
#SBATCH --job-name=BCOS_NES_PGD
#SBATCH --output=NES_PGD/mps_%j.out
#SBATCH --error=NES_PGD/mps_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
NES_M=50
NES_SIGMA=0.00392156862745098
NES_EVAL_BATCH_SIZE=256
...
run_nes_pgd() {
    ...
    echo "===================================================="
    echo "Running NES_PGD: model_type=$model_type | model_name=$model_name"

    local cmd=(
        python NES_PGD_attack.py
        ...
        --nes-m "$NES_M"
        --nes-sigma "$NES_SIGMA"
        --nes-eval-batch-size "$NES_EVAL_BATCH_SIZE"
    )
...
run_nes_pgd "torchvision" "resnet50"
run_nes_pgd "torchvision" "densenet121"
run_nes_pgd "torchvision" "vit_b_16"

run_nes_pgd "bcos" "resnet_50"
run_nes_pgd "bcos" "densenet_121"
run_nes_pgd "bcos" "simple_vit_b_patch16_224"

run_nes_pgd "bcosify" "resnet_50"
run_nes_pgd "bcosify" "densenet_121"
run_nes_pgd "bcosify" "simple_vit_b_patch16_224" \
    "$PROJECT_ROOT/checkpoints/bcosify/bcosifyv2_bcos_simple_vit_b_patch16_224_0.001_lrWarmup_gapReorder.ckpt"

echo "===================================================="
echo "Done running NES_PGD for all 9 models. Output: $OUTPUT_ROOT"